...
Procedure.s PmdCall(*Node.PmoOnnxNode, Map Ids.i())
  ...
  Select op
    ...
    Case "If","Loop","Scan","SequenceMap","SequenceEmpty","SequenceConstruct","SequenceInsert","SequenceAt","SequenceLength","SequenceErase","SplitToSequence","ConcatFromSequence"
      call=PmcCall(*Node)
    Case "MatMul"
