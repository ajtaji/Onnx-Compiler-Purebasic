...
<p align="center">
  ...
  <img alt="Python: not required" src="https://img.shields.io/badge/Python-not_required-65d9c5?style=flat-square">
...
- **No Python:** the compiler, window, build helper, and examples are PureBasic.
...
Verified with **PureBasic 6.21, Windows x64, native assembly backend**.
...
examples/                   PureBasic-only model creation and Windows consumer
...
private keys, model data, or Python tools are distributed in this repository.
